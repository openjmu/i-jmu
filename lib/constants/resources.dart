...
class R {
  ...
  static const String ASSETS_PLACEHOLDER_NO_MESSAGE_SVG =
      'assets/placeholder/no-message.svg';

  static const String ASSETS_PLACEHOLDER_NO_NETWORK_SVG =
      'assets/placeholder/no-network.svg';

  static const String ASSETS_PLACEHOLDER_SEARCH_NO_RESULT_SVG =
      'assets/placeholder/search-no-result.svg';
}
